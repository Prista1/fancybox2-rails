...
Gem::Specification.new do |s|
  ...
  s.summary     = "Use FancyBox 2 with Rails 3.1/4.0/5.x"
  s.description = "This gem provides jQuery FancyBox 2 for your Rails 3.1/4.0/5.x application. This gem is based on the gem for Fancybox 1.x by Chris Mytton"
